      ...
      <ul class="mt-8 space-y-2 tracking-wide">
        <li>
          <RouterLink to="/" aria-label="dashboard"
            class="group flex items-center space-x-4 px-4 py-3 text-gray-600 dark:text-gray-300"
            active-class="rounded-xl bg-gradient-to-r from-sky-600 to-cyan-400 text-white"
          >
        ...
        <li>
          <RouterLink to="/invoice" aria-label="invoice"
            class="group flex items-center space-x-4 px-4 py-3 text-gray-600 dark:text-gray-300"
            active-class="rounded-xl bg-gradient-to-r from-sky-600 to-cyan-400 text-white"
          >
            <svg class="-ml-1 h-6 w-6" viewBox="0 0 24 24" fill="none">
        ...
        <li>
          <RouterLink to="/about" aria-label="categroies"
            class="group flex items-center space-x-4 px-4 py-3 text-gray-600 dark:text-gray-300"
            active-class="rounded-xl bg-gradient-to-r from-sky-600 to-cyan-400 text-white"
          >
            <svg
